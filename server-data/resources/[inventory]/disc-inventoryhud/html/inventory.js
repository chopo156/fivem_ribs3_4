...
function inventorySetup(invOwner, items, money, invTier) {
    setupPlayerSlots();
    $('#player-inv-label').html('Inventory');     // $('#player-inv-label').html(char.firstname +' '+ char.lastname + ' [' + charid + ']');
...
$(document).ready(function () {
    ...
    $("#take").mouseenter(function () {
        ...
        $('.near-players-wrapper').find('.popup-body').html('');
        $('.near-players-wrapper').find('.popup-body').html('');
        $('.near-players-list .popup-body').append(`<div class="cashtake" data-id="cash">Nakit Para</div>`);
    ...
    $("#store").mouseenter(function () {
        ...
        $('.near-players-wrapper').find('.popup-body').html('');
        $('.near-players-wrapper').find('.popup-body').html('');
        $('.near-players-list .popup-body').append(`<div class="cashstore" data-id="cash">Nakit Para</div>`);
    ...
    $("#pay").mouseenter(function () {
        ...
        successAudio.play();
        $('.near-players-wrapper').find('.popup-body').html('');
        $('.near-players-list .popup-body').append(`<div class="cashchoice" data-id="cash">Nakit Para</div>`);
