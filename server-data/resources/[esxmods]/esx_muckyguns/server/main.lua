...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'muckyguns', Config.MaxInService)
end

TriggerEvent('esx_phone:registerNumber', 'muckyguns', _U('alert_Woodyguns'), true, true)
TriggerEvent('esx_society:registerSociety', 'muckyguns', 'muckyguns', 'society_muckyguns', 'society_muckyguns', 'society_muckyguns', {type = 'public'})
...
AddEventHandler('esx_mafiajob:getStockItem', function(itemName, count)
  ...
  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_muckyguns', function(inventory)
...
ESX.RegisterServerCallback('esx_mafiajob:getArmoryWeapons', function(source, cb)
  ...
  TriggerEvent('esx_datastore:getSharedDataStore', 'society_muckyguns', function(store)
...
ESX.RegisterServerCallback('esx_mafiajob:buy', function(source, cb, amount)
  ...
  TriggerEvent('esx_addonaccount:getSharedAccount', 'society_muckyguns', function(account)
