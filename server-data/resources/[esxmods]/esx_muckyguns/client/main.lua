...
AddEventHandler('esx_mafiajob:hasEnteredEntityZone', function(entity)
  ...
  if PlayerData.job ~= nil and PlayerData.job.name == 'muckyguns' and not IsPedInAnyVehicle(playerPed, false) then
...
Citizen.CreateThread(function()
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'muckyguns' then
      ...
      for k,v in pairs(Config.MafiaStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.name == 'muckyguns' and PlayerData.job.grade_name == 'boss' then
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'muckyguns' and (GetGameTimer() - GUI.Time) > 150 then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'muckyguns', vehicleProps)
            ...
            then
              TriggerServerEvent('esx_service:disableService', 'muckyguns')
            end
        ...
        if CurrentAction == 'menu_boss_actions' then
          ...
          TriggerEvent('esx_society:openBossMenu', 'muckyguns', function(data, menu)
  ...
  if IsControlPressed(0,  Keys['F6']) and PlayerData.job ~= nil and PlayerData.job.name == 'muckyguns' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'mafia_actions') and (GetGameTimer() - GUI.Time) > 150 then
